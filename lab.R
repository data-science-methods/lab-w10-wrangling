...
# Robust Intelligence, Comm & Information Foundations
# Ashok Veeraraghavan
# $589,000.00 (not $573,000.00)
#' 
#' 
# Daniel Lee (347132) doesn't have a record
# Christopher Bailey-Kellogg (631821) doesn't have a record

#' Formatting is fine (assuming no decimal values lost (all were .00) but we're seeing at least one discrepancy in the dataset)
#' Also missing a couple of records for the given IDs
...
#' 
#' class: character
#' formatted: differently - we have some MM/DD/YYYY and some with an integer value (which, reading ahead, seems to be the days past since the serial date)
...
#' 
#' It's confusing MM/DD/YYYY for DD/MM/YYYY in some cases (Excel is confused about this as well, cuz obviously months don't go > 12) -- we want MM/DD/YYYY
#' 
