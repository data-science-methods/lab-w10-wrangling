...
ri_df <- readxl::read_excel(file.path('data', '7495_Robust-Intelligence.xlsx'), n_max = 25)
...
#' AwardNumber; State; Organization; AWardedAmountToDate
#' 
#' 
...
#' row 6 is wrong; showing 589,000 on the NSF website
#' row 7 is also wrong; showing 547,810 on the NSF website
#' 
...
#' this is a character class, probablye because of the / in some dates
#' 
...
#' The dates are represented YYYY-DD-MM when we want them to be YYYY-MM-DD 
#' 
#' 
...
parsed_dates <- ifelse(is.na(mdy_dates), int_dates2, mdy_dates)
